...
func formatAdminDashboard(metrics domain.AdminDashboard, view adminView, now time.Time) string {
	var body string
	switch view {
...
func formatAdminOverview(metrics domain.AdminDashboard) string {
	return fmt.Sprintf(
		"<b>Owner dashboard</b> 🔐\n\n"+
			"👤 <b>Users</b>: %d\n"+
			"👥 <b>Groups</b>: %d\n"+
...
func formatAdminActivity(metrics domain.AdminDashboard) string {
	return fmt.Sprintf(
		"<b>User activity</b> ⚡\n\n"+
...
func formatAdminLanguages(metrics domain.AdminDashboard) string {
...
func formatAdminMethods(metrics domain.AdminDashboard) string {
	var builder strings.Builder
...
func formatAdminReminders(metrics domain.AdminDashboard) string {
...
func formatAdminHealth(metrics domain.AdminDashboard) string {
