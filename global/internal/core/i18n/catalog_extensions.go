	...
	extensions := map[string]localeExtension{
		"en": {
			...
			text: map[string]string{
				...
				"city_usage":           "Type the place name after the command, e.g. <code>/city Istanbul</code>.",
				"city_no_results":      "No place found with that name. Try adding the country, e.g. <code>/city Tripoli, Lebanon</code>.",
				"city_choose":          "<b>Choose your location</b> 📍",
		...
		"ar": {
			...
			text: map[string]string{
				...
				"city_usage":           "اكتب اسم المكان بعد الأمر، مثال: <code>/city القاهرة</code>.",
				"city_no_results":      "لم أجد مكانًا بهذا الاسم. جرّب إضافة الدولة، مثال: <code>/city طرابلس، لبنان</code>.",
				"city_choose":          "<b>اختر موقعك</b> 📍",
		...
		"es": {
			...
			text: map[string]string{
				...
				"city_usage":           "Escribe el nombre del lugar después del comando, p. ej. <code>/city Madrid</code>.",
				"city_no_results":      "No encontré ningún lugar con ese nombre. Prueba añadiendo el país, p. ej. <code>/city Córdoba, España</code>.",
				"city_choose":          "<b>Elige tu ubicación</b> 📍",
		...
		"fr": {
			...
			text: map[string]string{
				...
				"city_usage":           "Écrivez le nom du lieu après la commande, ex. <code>/city Paris</code>.",
				"city_no_results":      "Aucun lieu trouvé avec ce nom. Essayez d'ajouter le pays, ex. <code>/city Tripoli, Liban</code>.",
				"city_choose":          "<b>Choisissez votre lieu</b> 📍",
		...
		"ru": {
			...
			text: map[string]string{
				...
				"city_usage":           "Укажите название места после команды, например <code>/city Казань</code>.",
				"city_no_results":      "Место с таким названием не найдено. Попробуйте добавить страну, например <code>/city Тараз, Казахстан</code>.",
				"city_choose":          "<b>Выберите ваше местоположение</b> 📍",
		...
		"tr": {
			...
			text: map[string]string{
				...
				"city_usage":           "Komuttan sonra yer adını yazın, örn. <code>/city İstanbul</code>.",
				"city_no_results":      "Bu adla bir yer bulunamadı. Ülke ekleyerek deneyin, örn. <code>/city Trablus, Lübnan</code>.",
				"city_choose":          "<b>Konumunuzu seçin</b> 📍",
		...
		"uz": {
			...
			text: map[string]string{
				...
				"city_usage":           "Buyruqdan keyin joy nomini yozing, masalan <code>/city Toshkent</code>.",
				"city_no_results":      "Bunday nomli joy topilmadi. Mamlakat qo‘shib ko‘ring, masalan <code>/city Tripoli, Livan</code>.",
				"city_choose":          "<b>Joylashuvingizni tanlang</b> 📍",
		...
		"tt": {
			...
			text: map[string]string{
				...
				"city_usage":           "Команда артыннан урын исемен языгыз, мәсәлән <code>/city Казан</code>.",
				"city_no_results":      "Мондый исемле урын табылмады. Ил өстәп карагыз, мәсәлән <code>/city Казан, Россия</code>.",
				"city_choose":          "<b>Урыныгызны сайлагыз</b> 📍",
