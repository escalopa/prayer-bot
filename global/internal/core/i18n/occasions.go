...
var occasionUI = map[string]map[string]string{
	"en": {
		...
		"observed_reminders": "Community observances", "schedule": "Evening before · 20:00",
		...
		"observed_reminders_help": "Dates observed in some communities, including Mawlid, Isra and Mi’raj, and Mid-Sha’ban.",
	},
	"ar": {
		...
		"observed_reminders": "مناسبات مجتمعية", "schedule": "مساء اليوم السابق · 20:00",
		...
		"observed_reminders_help": "تواريخ تحييها بعض المجتمعات، منها المولد والإسراء والمعراج ومنتصف شعبان.",
	},
	"es": {
		...
		"observed_reminders": "Conmemoraciones comunitarias", "schedule": "Víspera · 20:00",
		...
		"observed_reminders_help": "Fechas observadas en algunas comunidades, como el Mawlid, Isra y Mi’raj y mediados de Sha’ban.",
	},
	"fr": {
		...
		"observed_reminders": "Célébrations communautaires", "schedule": "La veille · 20:00",
		...
		"observed_reminders_help": "Dates observées dans certaines communautés, dont le Mawlid, l’Isra et Mi’raj, et la mi-Chaabane.",
	},
	"ru": {
		...
		"observed_reminders": "Памятные даты общин", "schedule": "Накануне · 20:00",
		...
		"observed_reminders_help": "Даты, отмечаемые в некоторых общинах: Маулид, Исра и Мирадж и середина Шаабана.",
	},
	"tr": {
		...
		"observed_reminders": "Toplumsal anma günleri", "schedule": "Önceki akşam · 20:00",
		...
		"observed_reminders_help": "Bazı topluluklarda anılan Mevlid, İsra ve Miraç ile Berat Kandili gibi günler.",
	},
	"uz": {
		...
		"observed_reminders": "Jamoalardagi esdalik sanalar", "schedule": "Oldingi oqshom · 20:00",
		...
		"observed_reminders_help": "Ba’zi jamoalarda nishonlanadigan Mavlid, Isro va Me’roj hamda Sha’bon o‘rtasi kabi sanalar.",
	},
	"tt": {
		...
		"observed_reminders": "Җәмәгатьләрдә билгеләнә торган көннәр", "schedule": "Алдагы кич · 20:00",
		...
		"observed_reminders_help": "Кайбер җәмгыятьләрдә билгеләнә торган Мәүлет, Исра һәм Мигъраҗ, Шәгъбан уртасы кебек көннәр.",
	},
}
