...
// RecommendedMethod picks the calculation authority conventionally used in a
// country. Unlisted countries default to the Muslim World League method.
func RecommendedMethod(countryCode string) Method {
	...
	case "TR":
		return MethodDiyanet
	case "ID":
		return MethodKemenag
	case "SG":
		return MethodMUIS
	case "MY":
		return MethodJAKIM
